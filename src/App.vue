...
const options = {
    ...
    headers: {
        ...
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJmYmMzNjZhMjRmM2ViZWYzODJjMWY4Yjc2NWE5MWU3NiIsInN1YiI6IjY1Mjc3ZTFjMGNiMzM1MTZmZDQ4NDhiYyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.cb1qWe8vZfI4HIttjqQU_MTUO8Iu0tEmZ0qFwRe0HNY'
    }
}; // 영화 API 옵션 걊
